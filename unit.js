 ...
 * @param {Object}
 */
export const changeOrientation = function($print, height) {
  var gh = height || 60; //旋转物体实际的高度
  var width = document.documentElement.clientWidth; //满屏宽度
  var height = document.documentElement.clientHeight; //满屏高度
  if (width < height) {
    $print.width(height);
    $print.height(gh);
    $print.css("top", (height - gh) / 2);
    $print.css("left", 0 - (height - gh) / 2);
...
// 复制画布
export const cropSignatureCanvas = function(canvas) {
